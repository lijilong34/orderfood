...
import { Ft as onMounted, Jt as renderSlot, Kn as ref, Ot as nextTick, Vt as openBlock, gn as watch, nt as defineComponent, p as render, pt as h, q as createElementBlock, zt as onUnmounted } from "./vue.runtime.esm-bundler-7foM4kIy.js";
...
var require_viewer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(global$1, factory) {
		typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global$1 = typeof globalThis !== "undefined" ? globalThis : global$1 || self, global$1.Viewer = factory());
	})(exports, (function() {
		"use strict";
		...
		*/
		var assign = Object.assign || function assign$1(obj) {
		...
		*/
		...
		var onceSupported = function() {
			...
			if (IS_BROWSER) {
				var once = false;
				var listener = function listener$1() {};
		...
		*/
		...
		var render$1 = {
			...
			initList: function initList() {
				...
				forEach(items, function(item) {
					...
					addListener(image, EVENT_LOAD, onLoad = function onLoad$1(event) {
						removeListener(image, EVENT_ERROR, onError);
						if (options.loading) removeClass(item, CLASS_LOADING);
						_this.loadImage(event);
					}, { once: true });
					addListener(image, EVENT_ERROR, onError = function onError$1() {
			...
			renderImage: function renderImage(done) {
				...
				if (done) if ((this.viewing || this.moving || this.rotating || this.scaling || this.zooming) && this.options.transition && hasClass(image, CLASS_TRANSITION)) {
					var onTransitionEnd = function onTransitionEnd$1() {
		...
		var events = {
			bind: function bind() {
				...
				var document$1 = this.element.ownerDocument;
				addListener(viewer, EVENT_CLICK, this.onClick = this.click.bind(this));
				addListener(viewer, EVENT_DRAG_START, this.onDragStart = this.dragstart.bind(this));
				addListener(canvas, EVENT_POINTER_DOWN, this.onPointerDown = this.pointerdown.bind(this));
				addListener(document$1, EVENT_POINTER_MOVE, this.onPointerMove = this.pointermove.bind(this));
				addListener(document$1, EVENT_POINTER_UP, this.onPointerUp = this.pointerup.bind(this));
				addListener(document$1, EVENT_KEY_DOWN, this.onKeyDown = this.keydown.bind(this));
			...
			unbind: function unbind() {
				...
				removeListener(document$1, EVENT_POINTER_MOVE, this.onPointerMove);
				removeListener(document$1, EVENT_POINTER_UP, this.onPointerUp);
				removeListener(document$1, EVENT_KEY_DOWN, this.onKeyDown);
		...
		var methods = {
			...
			hide: function hide() {
				...
				var hideImmediately = function hideImmediately$1() {
					removeClass(viewer, CLASS_IN);
					_this.hidden();
				};
				if (options.transition && !immediate) {
					...
					var onImageTransitionEnd = function onImageTransitionEnd$1() {
			...
			view: function view() {
				...
				this.renderList();
				title.innerHTML = "";
				var onViewed = function onViewed$1() {
					var imageData = _this2.imageData;
					var render$2 = Array.isArray(options.title) ? options.title[1] : options.title;
					title.innerHTML = escapeHTMLEntities(isFunction(render$2) ? render$2.call(_this2, image, imageData) : "".concat(alt, " (").concat(imageData.naturalWidth, " × ").concat(imageData.naturalHeight, ")"));
				};
				var onLoad;
				var onError;
				...
				if (image.complete) this.load();
					...
					addListener(image, EVENT_LOAD, onLoad = function onLoad$1() {
						removeListener(image, EVENT_ERROR, onError);
						_this2.load();
					}, { once: true });
					addListener(image, EVENT_ERROR, onError = function onError$1() {
		...
		var others = {
			...
			requestFullscreen: function requestFullscreen(options) {
				var document$1 = this.element.ownerDocument;
				if (this.fulled && !(document$1.fullscreenElement || document$1.webkitFullscreenElement || document$1.mozFullScreenElement || document$1.msFullscreenElement)) {
			...
			exitFullscreen: function exitFullscreen() {
				var document$1 = this.element.ownerDocument;
				if (this.fulled && (document$1.fullscreenElement || document$1.webkitFullscreenElement || document$1.mozFullScreenElement || document$1.msFullscreenElement)) {
					if (document$1.exitFullscreen) document$1.exitFullscreen();
					else if (document$1.webkitExitFullscreen) document$1.webkitExitFullscreen();
					else if (document$1.mozCancelFullScreen) document$1.mozCancelFullScreen();
					else if (document$1.msExitFullscreen) document$1.msExitFullscreen();
				}
			},
		...
		var Viewer = /* @__PURE__ */ function() {
			...
			*/
			function Viewer$1(element) {
				var options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
				_classCallCheck(this, Viewer$1);
			...
			return _createClass(Viewer$1, [{
				...
				value: function init() {
					...
					if (options.inline) {
						var count = 0;
						var progress = function progress$1() {
							count += 1;
		...
		assign(Viewer.prototype, render$1, events, handlers, methods, others);
		return Viewer;
	}));
}));

//#endregion
//#region node_modules/v-viewer/dist/index.js
var import_viewer = /* @__PURE__ */ __toESM(require_viewer(), 1);
var import_viewer$1 = /* @__PURE__ */ __toESM(require_viewer(), 1);
var re = typeof global == "object" && global && global.Object === Object && global;
var _e = typeof self == "object" && self && self.Object === Object && self;
var E = re || _e || Function("return this")();
var S = E.Symbol;
...
var q = NaN, Ge = /^[-+]0x[0-9a-f]+$/i, He = /^0b[01]+$/i, qe = /^0o[0-7]+$/i, Je = parseInt;
function J(e) {
...
var nr = /[\\^$.*+?()[\]{}|]/g, ir = /^\[object .+?Constructor\]$/, or = Function.prototype, ar = Object.prototype, ur = or.toString, sr = ar.hasOwnProperty, cr = RegExp("^" + ur.call(sr).replace(nr, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function fr(e) {
	if (!b(e) || ke(e)) return !1;
	return (ie(e) ? cr : ir).test(tr(e));
}
function dr(e, r) {
...
function pr(e, r, t) {
	switch (t.length) {
		case 0: return e.call(r);
		case 1: return e.call(r, t[0]);
		case 2: return e.call(r, t[0], t[1]);
		case 3: return e.call(r, t[0], t[1], t[2]);
	}
	return e.apply(r, t);
}
...
function Sr(e, r, t) {
	return r = z(r === void 0 ? e.length - 1 : r, 0), function() {
		for (var n = arguments, i = -1, u = z(n.length - r, 0), c = Array(u); ++i < u;) c[i] = n[r + i];
		i = -1;
...
function L(e) {
	...
	return e === (typeof r == "function" && r.prototype || Mr);
}
function Vr(e, r) {
...
var de = Object.prototype, Br = de.hasOwnProperty, Ur = de.propertyIsEnumerable;
var Nr = Q(function() {
	return arguments;
}()) ? Q : function(e) {
...
var le = typeof exports == "object" && exports && !exports.nodeType && exports, Y = le && typeof module == "object" && module && !module.nodeType && module, Z = Y && Y.exports === le ? E.Buffer : void 0;
var Kr = (Z ? Z.isBuffer : void 0) || Dr;
...
var pe = typeof exports == "object" && exports && !exports.nodeType && exports, j = pe && typeof module == "object" && module && !module.nodeType && module, N = j && j.exports === pe && re.process;
var k = function() {
	try {
		return j && j.require && j.require("util").types || N && N.binding && N.binding("util");
	} catch {}
}();
...
function ge(e, r) {
	...
	for (var s in e) (r || Tt.call(e, s)) && !(c && (s == "length" || i && (s == "offset" || s == "parent") || u && (s == "buffer" || s == "byteLength" || s == "byteOffset") || oe(s, d))) && a.push(s);
	return a;
}
function $t(e, r) {
	return function(t) {
...
var jt = $t(Object.keys, Object);
var At = Object.prototype.hasOwnProperty;
function xt(e) {
	if (!L(e)) return jt(e);
	var r = [];
	for (var t in Object(e)) At.call(e, t) && t != "constructor" && r.push(t);
	return r;
}
function Pt(e) {
...
var Mt = Er(function(e, r) {
	if (L(r) || C(r)) {
		Pr(r, Pt(r), e);
		return;
	}
	for (var t in r) It.call(r, t) && ue(e, t, r[t]);
});
function Vt(e) {
	var r = [];
...
function Ut(e) {
	if (!b(e)) return Vt(e);
	var r = L(e), t = [];
	for (var n in e) n == "constructor" && (r || !Bt.call(e, n)) || t.push(n);
	return t;
}
function Ft(e) {
...
function Rt(e, r, t) {
	...
	function U() {
		...
		if (n = arguments, i = this, d = p, y) {
			if (a === void 0) return v(d);
			if (o) return clearTimeout(a), a = setTimeout(T, r), g(d);
		}
		return a === void 0 && (a = setTimeout(T, r)), c;
	}
	return U.cancel = B, U.flush = ye, U;
}
var ve = Object.prototype, Kt = ve.hasOwnProperty;
var Ht = se(function(e, r) {
	e = Object(e);
	var t = -1, n = r.length, i = n > 2 ? r[2] : void 0;
	for (i && fe(r[0], r[1], i) && (n = 1); ++t < n;) for (var u = r[t], c = Ft(u), a = -1, d = c.length; ++a < d;) {
		var s = c[a], m = e[s];
		(m === void 0 || W(m, ve[s]) && !Kt.call(e, s)) && (e[s] = u[s]);
	}
	return e;
}), qt = ({ images: e = [], options: r }) => {
	r = Mt(r, { inline: !1 });
	const t = document.createElement("div");
	render(h("div", {
		style: { display: "none" },
		class: ["__viewer-token"]
	}, e.map((a) => h("img", typeof a == "string" ? { src: a } : a))), t);
	const i = t.firstElementChild;
	document.body.appendChild(i);
	const u = new import_viewer.default(i, r), c = u.destroy.bind(u);
	...
	async function t(o, l, g = !1, v = !1) {
		await nextTick(), !(v && !n(o)) && (g || !o[`$${e}`] ? (c(o), o[`$${e}`] = new import_viewer.default(o, l), s("Viewer created")) : (o[`$${e}`].update(), s("Viewer updated")));
	}
	function n(o) {
	...
	function i(o, l, g, v) {
		a(o);
		const h$1 = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver;
		if (!h$1) {
		...
		w.observe(o, {
			...
			characterData: !0,
			subtree: !0
		}), o.__viewerMutationObserver = w, s("Observer created");
	}
	function u(o, l, g, v) {
		o.__viewerUnwatch = watch(() => l.value, (h$1, w) => {
			s("Change detected by watcher: ", l.value), v(o, h$1, !0, !1);
	...
	setup(e, { emit: r }) {
		...
		const n = ref();
		function i() {
			t = new import_viewer.default(n.value, e.options), r("inited", t);
		}
		function u() {
			t && t.destroy();
		}
	...
	for (const [n, i] of r) t[n] = i;
	return t;
}, Qt = { ref: "root" };
function Yt(e, r, t, n, i, u) {
	return openBlock(), createElementBlock("div", Qt, [renderSlot(e.$slots, "default", {
		images: e.images,
		options: e.options
	})], 512);
}
var Zt = /* @__PURE__ */ zt(Xt, [["render", Yt]]), rn = {
	install(e, { name: r = "viewer", debug: t = !1, defaultOptions: n } = {}) {
		n && import_viewer.default.setDefaults(n), e.config.globalProperties[`$${r}Api`] = qt, e.component(r, Ht(Zt, { name: r })), e.directive(r, Jt({
			name: r,
			debug: t
		}));
	},
	setDefaults(e) {
		import_viewer.default.setDefaults(e);
	}
};

//#endregion
var on = import_viewer$1.default;
export { on as Viewer, qt as api, Zt as component, rn as default, Jt as directive };
